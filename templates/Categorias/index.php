        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('Visualizar'), ['action' => 'view', $categoria->id]) ?>
                        <?= $this->Html->link(__('Editar'), ['action' => 'edit', $categoria->id]) ?>
                        <?= $this->Form->postLink(__('Apagar'), ['action' => 'delete', $categoria->id], ['confirm' => __('Are you sure you want to delete # {0}?', $categoria->id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
